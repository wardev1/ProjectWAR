...
{
    public class SimpleHighPriestHerakh1 : InstanceBossSpawn
    {
        #region Constructors
        public SimpleHighPriestHerakh1(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
