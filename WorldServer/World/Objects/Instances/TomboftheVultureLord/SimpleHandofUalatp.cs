...
{
    public class SimpleHandofUalatp : InstanceBossSpawn
    {
        #region Constructors
        public SimpleHandofUalatp(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
