...
{
    public class SimpleThananTreeLord : InstanceBossSpawn
    {
        #region Constructors
        public SimpleThananTreeLord(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
