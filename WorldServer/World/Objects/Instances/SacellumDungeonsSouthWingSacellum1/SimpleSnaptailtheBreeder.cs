...
{
    public class SimpleSnaptailtheBreeder : InstanceBossSpawn
    {
        #region Constructors
        public SimpleSnaptailtheBreeder(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
