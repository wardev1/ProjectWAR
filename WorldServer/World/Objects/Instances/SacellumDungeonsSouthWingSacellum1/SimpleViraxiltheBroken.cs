...
{
    public class SimpleViraxiltheBroken : InstanceBossSpawn
    {
        #region Constructors
        public SimpleViraxiltheBroken(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
