...
{
    public class SimpleBulbousOne : InstanceBossSpawn
    {
        #region Constructors
        public SimpleBulbousOne(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
