...
{
    public class SimpleTheBileLord : InstanceBossSpawn
    {
        #region Constructors
        public SimpleTheBileLord(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
