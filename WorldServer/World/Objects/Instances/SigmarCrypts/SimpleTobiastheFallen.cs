...
{
    public class SimpleTobiastheFallen : InstanceBossSpawn
    {
        #region Constructors
        public SimpleTobiastheFallen(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
