...
{
    public class SimpleSisterEudocia : InstanceBossSpawn
    {
        #region Constructors
        public SimpleSisterEudocia(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
