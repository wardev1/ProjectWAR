...
{
    public class SimpleCryptwebQueen : InstanceBossSpawn
    {
        #region Constructors
        public SimpleCryptwebQueen(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
