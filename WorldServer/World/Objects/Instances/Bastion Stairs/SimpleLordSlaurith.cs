...
{
    public class SimpleLordSlaurith : InstanceBossSpawn
    {
        #region Constructors

        public SimpleLordSlaurith(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
