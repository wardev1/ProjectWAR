...
{
    public class SimpleSaaKhasef : InstanceBossSpawn
    {
        #region Constructors
        public SimpleSaaKhasef(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
