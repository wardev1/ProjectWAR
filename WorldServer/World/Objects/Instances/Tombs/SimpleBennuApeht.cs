...
{
    public class SimpleBennuApeht : InstanceBossSpawn
    {
        #region Constructors
        public SimpleBennuApeht(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
