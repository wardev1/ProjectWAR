...
{
    public class SimpleHoarfrost : InstanceBossSpawn
    {
        #region Constructors
        public SimpleHoarfrost(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
