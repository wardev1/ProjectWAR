...
namespace WorldServer.World.Objects.Instances.SacellumDungeonsWestWingSacellum2
{
    public class SimpleSlorthThunderbelly : InstanceBossSpawn
    {
        #region Constructors
        public SimpleSlorthThunderbelly(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
