...
{
    public class SimpleGreySeerQuoltik : InstanceBossSpawn
    {
        #region Constructors
        public SimpleGreySeerQuoltik(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
