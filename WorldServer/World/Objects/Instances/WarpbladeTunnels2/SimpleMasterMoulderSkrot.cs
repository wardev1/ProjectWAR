...
namespace WorldServer.World.Objects.Instances.WarpbladeTunnels2
{
    public class SimpleMasterMoulderSkrot : InstanceBossSpawn
    {
        #region Constructors
        public SimpleMasterMoulderSkrot(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
