...
namespace WorldServer.World.Objects.Instances.SacellumDungeonsWestWingSacellum3
{
    public class SimpleGhalmarRagehorn : InstanceBossSpawn
    {
        #region Constructors
        public SimpleGhalmarRagehorn(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
