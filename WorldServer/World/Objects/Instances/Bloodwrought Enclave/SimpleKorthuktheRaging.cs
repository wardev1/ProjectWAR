...
{
    public class SimpleKorthuktheRaging : InstanceBossSpawn
    {
        #region Constructors
        public SimpleKorthuktheRaging(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
