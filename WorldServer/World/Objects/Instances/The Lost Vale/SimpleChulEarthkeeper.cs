...
{
    public class SimpleChulEarthkeeper : InstanceBossSpawn
    {
        #region Constructors
        public SimpleChulEarthkeeper(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
