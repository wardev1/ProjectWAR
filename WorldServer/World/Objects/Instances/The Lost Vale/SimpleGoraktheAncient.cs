...
{
    public class SimpleGoraktheAncient : InstanceBossSpawn
    {
        #region Constructors
        public SimpleGoraktheAncient(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
