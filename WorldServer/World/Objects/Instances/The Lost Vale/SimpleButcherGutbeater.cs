...
{
    public class SimpleButcherGutbeater : InstanceBossSpawn
    {
        #region Constructors
        public SimpleButcherGutbeater(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
