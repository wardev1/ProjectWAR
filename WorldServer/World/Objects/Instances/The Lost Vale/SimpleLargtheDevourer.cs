...
{
    public class SimpleLargtheDevourer : InstanceBossSpawn
    {
        #region Constructors
        public SimpleLargtheDevourer(Creature_spawn spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
